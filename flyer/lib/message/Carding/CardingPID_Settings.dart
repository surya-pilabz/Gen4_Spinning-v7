...
class PidSettings{
  ...
  String getMotorHexFromName(String motorName) {
    switch (motorName) {
      case "CARD CYLINDER":
        return MotorId.cylinder.hexVal;
      case "BEATER CYLINDER":
        return MotorId.beater.hexVal;
      case "CAGE":
        return MotorId.cage.hexVal;
      case "CARDING FIELD":
        return MotorId.cylinderFeed.hexVal;
      case "BEATER FEED":
        return MotorId.beaterFeed.hexVal;
      case "COILER":
        return MotorId.coiler.hexVal;
      case "PICKER CYLINDER":
        return MotorId.picker_cylinder.hexVal;
      case "AF FEED":
        return MotorId.af_feed.hexVal;
      default:
        return MotorId.cylinder.hexVal;
    }
  }
